...
public class FFiles {
    ...
    /**
     * Provides methods for basic file and folder operations, copy-paste functionality, and file data manipulation.
     * <p>Author: <b>SzYr Feeham</b></p>
     * <p>Date of Implementation: <b>22 March 2020</b></p>
     * here are 3 types of methods with different operations:
     * <ul>
     * <li>
     * <b>Basic</b>
     * <ul>
     * <li>createFolder() - call with path as parameter to create a folder.</li>
     * <li>createFile() - call with path and format as parameter to create a file.</li>
     * <li>ifExists() - check if a folder or files exists or not.</li>
     * <li>rename() - call with path and new name as parameter to rename a file or folder.</li>
     * <li>delete() - call with path as parameter to delete a file or folder.</li>
     * </ul>
     * </li>
     * <li>
     * <b>CopyPaste</b>
     * <ul>
     * <li>copy() - copy a folder (it doesn't paste automatically, must call paste after it.)</li>
     * <li>cut() - cut a folder (it doesn't paste automatically, must call paste after it.)</li>
     * <li>paste() - call with path as parameter where you want to paste the copied or cutted file/folder.</li>
     * </ul>
     * </li>
     * <li>
     * <b>Use</b>
     * <ul>
     * <li>read() - read String data from a file.</li>
     * <li>changeData() - replace files' existing data with some new data.</li>
     * <li>addTo() - add some data after files' already existing data.</li>
     * <li>createAndWrite() - create a file and put some data into it in a single call.</li>
     * </ul> </li> </ul> <p>
     */
